...
<div id="wrap">
	<div class="full-width" id="banner">
		<div class="container">
			<div class="row">
				<div class="span12">
				<h5><a href="/contact/" >&#126; Call us at <span>307.739.4646</span> to book an appointment today. &#126;</a></h5>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="span5">
					...
					<img src="<?php bloginfo( 'template_url' ); ?>/img/champu_logo.png" width="250" alt="Champu Salon - Jackson Hole" />
					</a>
				</div><!-- /span5 -->
